describe("avoid_error", () => {
  ...
  it("creates manual delivery", () => {
    ...
    cy.chooseTeam("Testy automatyczne").then(() => {
      ...
      cy.get("#order_order_kind_pickup_delivery").click({ force: true })
            ...
            .then(() => {
              ...
              cy.get(".pac-container .pac-item")
                ...
                .then(() => {
                  ...
                  cy.get(".m-option").contains("Zapłacone").click()
                  ...
                  cy.get("[class=orderRowWrapper]")
                    .contains("Czas: " + "20" + " min " + "[" + text + "]")
                    .rightclick()
                  cy.get(".context-menu__item").contains("Anuluj - Bez zwrotu transakcji").click({ force: true })
                  cy.get(".context-menu__item .context-menu__item").contains("Anuluj").click({ force: true })
                  cy.get("#spop--top-right").contains("Zlecenie anulowane").should("be.visible")
                })
            })
        })
    })
